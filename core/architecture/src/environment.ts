 ...
 */
const propsArray: ArrEnvironment = Object.keys(new CEnvironment()) as ArrEnvironment;
...
export const filterEnvironmentProps = (
    ...
    const data = Object.assign(
        propsArray.reduce(
            (r: IEnvironment, k: keyof CEnvironment) => {
...
export const filterNonEnvironmentProps = (props: any) =>
    Object.keys(props).reduce((r: any, k: string) => {
        return Object.assign(r, 
            !propsArray.includes(k as keyof CEnvironment) ? { [k]: props[k] } : {}
        )
